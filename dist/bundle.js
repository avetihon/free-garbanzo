...
/***/ function(module, exports, __webpack_require__) {
	...
	var _snake = __webpack_require__(17);
	
	var _food = __webpack_require__(18);
	...
	var Snake = exports.Snake = function () {
	  ...
	  _createClass(Snake, [{
	    ...
	    value: function animateMove() {
	      ...
	      var newInterval = requestAnimationFrame(function () {
	    ...
	    value: function checkBoundaries() {
	      var headYCoord = parseInt(this.element.style.top, 10);
	      var headXCoord = parseInt(this.element.style.left, 10);
	      var snakePart = this.currentSnakePartsCoordinates();
	
	      snakePart.pop();
	
	      var levelSize = _init.level.levelArea();
	...
	var Engine = exports.Engine = function () {
	  ...
	  _createClass(Engine, [{
	    ...
	    value: function generateNewFoodCoordinates() {
	      ...
	      var foodXCoord = this.createRandomNumbers(0, levelArea.width);
	      var foodYCoord = this.createRandomNumbers(0, levelArea.height);
