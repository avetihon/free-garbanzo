...
/***/ function(module, exports) {
	...
	var Snake = exports.Snake = function () {
	  ...
	  _createClass(Snake, [{
	    ...
	    key: 'setIntervalNumber',
	    value: function setIntervalNumber(interval) {
	      this.interval = interval;
	    }
	  }, {
	    key: 'getIntervalNumber',
	    value: function getIntervalNumber() {
	    ...
	    value: function moveTo(direction) {
	      var interval = this.getIntervalNumber();
	      if (interval) {
