...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.food = exports.snake = exports.level = exports.setupModule = undefined;
	
	var _level = __webpack_require__(10);
	
	var _snake = __webpack_require__(11);
	
	var _food = __webpack_require__(12);
	
	var _engine = __webpack_require__(13);
	
	var setupModule = exports.setupModule = function () {
	  var elementsSize = 10;
	  var levelWidth = 300;
	  var levelHeight = 200;
	...
	var level = exports.level = new _level.Level(document.querySelector('.level'));
	var snake = exports.snake = new _snake.Snake(document.querySelector('.level'));
	var food = exports.food = new _food.Food(document.querySelector('.level'));
	
	var engine = new _engine.Engine(level, snake, food);
	engine.startNewGame();
	...
	var Snake = exports.Snake = function () {
	  ...
	  _createClass(Snake, [{
	    ...
	    value: function initSnakeBody(partCount) {
	      ...
	      while (i > 0) {
	        var newHeadXCoord = snakeXCoord - i * 10;
...
/***/ function(module, exports) {
	...
	var Engine = exports.Engine = function () {
	  function Engine(level, snake, food) {
	  ...
	  _createClass(Engine, [{
	    ...
	    value: function checkBoundaries() {
	      ...
	      var levelSize = this.level.levelArea();
	    ...
	    value: function generateNewFoodCoordinates() {
	      var levelArea = this.level.levelArea();
	      var snakeParts = this.snake.currentSnakePartsCoordinates();
	
	      var foodXCoord = this.createRandomPixelNumbers(0, levelArea.width);
	      var foodYCoord = this.createRandomPixelNumbers(0, levelArea.height);
	    ...
	    value: function gameLoop() {
	      ...
	      var requestID = this.requestNumber;
	      ...
	      var newRequestID = requestAnimationFrame(function () {
