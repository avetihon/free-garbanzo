...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilityModule = __webpack_require__(21);
	
	var gameInterface = new _interface.Interface(_settings.settings);
	var level = new _level.Level(_settings.settings);
	var snake = new _snake.Snake(_settings.settings);
	var food = new _food.Food();
	var engine = new _engine.Engine(level, snake, food, _settings.settings);
	engine.startNewGame();
	
	_utilityModule.titleModule.init();
	...
	var Level = exports.Level = function () {
	  ...
	  _createClass(Level, [{
	    ...
	    value: function levelArea() {
	      var width = this.settings.levelSizeByComponent.x * this.settings.componentSize;
	      var height = this.settings.levelSizeByComponent.y * this.settings.componentSize;
	    ...
	    value: function createLevelPalette() {
	      ...
	      for (var i = 0; i < this.settings.levelSizeByComponent.y; i++) {
	        var levelPaletteTR = document.createElement('tr');
	
	        for (var j = 0; j < this.settings.levelSizeByComponent.x; j++) {
	    ...
	    key: 'levelCoordinates',
	    value: function levelCoordinates() {
	...
	var Snake = exports.Snake = function () {
	  ...
	  _createClass(Snake, [{
	    ...
	    value: function initSnakeBody(partCount) {
	      var i = partCount;
	      var snakeXCoord = this.snakeHead.x;
	      var snakeYCoord = this.snakeHead.y;
	...
	var Engine = exports.Engine = function () {
	  ...
	  _createClass(Engine, [{
	    ...
	    value: function startNewGame() {
	      ...
	      var foodCoord = this.generateNewFoodCoordinates();
	    ...
	    value: function checkBoundaries() {
	      var snakeXCoord = this.snake.snakeHead.x;
	      var snakeYCoord = this.snake.snakeHead.y;
	      var snakePart = this.snake.currentSnakePartsCoordinates();
	
	      var _level$levelArea = this.level.levelArea();
	
	      var width = _level$levelArea.width;
	      var height = _level$levelArea.height;
	
	      // remove snake head coordinates
	
	      snakePart.pop();
	
	      if (snakeYCoord < 0 || snakeXCoord < 0 || snakeXCoord > width || snakeYCoord > height) {
	    ...
	    value: function checkIsSnakeEatFood() {
	      ...
	      var foodXCoord = this.food.getFoodPosition().x;
	      var foodYCoord = this.food.getFoodPosition().y;
	    ...
	    value: function generateNewFoodCoordinates() {
	      var levelCoordinates = this.level.levelCoordinates();
	      var snakeCoordinates = this.snake.currentSnakePartsCoordinates();
	
	      var res = _lodash2.default.differenceWith(levelCoordinates, snakeCoordinates, _lodash2.default.isEqual);
	      var randomCoordinate = Math.floor(Math.random() * res.length + 1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Interface = exports.Interface = function () {
	  function Interface(settings) {
	    ...
	    this.settings = settings;
	    _eventEmmiter.emmiter.addListener('updateScores', function () {
	      _this.updateScores();
	    });
	  }
...
/***/ function(module, exports) {
	...
	var titleModule = exports.titleModule = function () {
